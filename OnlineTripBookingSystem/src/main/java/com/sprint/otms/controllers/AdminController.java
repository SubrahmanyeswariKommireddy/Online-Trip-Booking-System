...
public class AdminController {
	...
	@PatchMapping("/admin/updateBusesByTravelId/{id}")
	public ResponseEntity<Travel> updateBusesByTravelId(@Valid @RequestBody Travel travel){
		return new ResponseEntity<Travel>(travelServiceImpl.updateTravel(travel),HttpStatus.OK);
	}
	...
	@PatchMapping("/admin/partialUpdateTravel/{id}")
	public ResponseEntity<Travel> partialUpdateTravel(@Valid @RequestBody Travel travel)
			throws TravelsNotFoundException, MethodArgumentNotValidException {

		LOGGER.info("partialUpdateTravel URL is opened");
		LOGGER.info("partialUpdatTravel() is initiated");
